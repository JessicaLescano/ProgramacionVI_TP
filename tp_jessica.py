...
def main(page: ft.Page):
    ...
    # Cambiar el color de fondo a rosa pastel
    page.bgcolor = ft.colors.PINK_100  # Rosa pastel
    ...
    # botones de "Agregar", "Modificar" y "Eliminar" con color lila
    add_button = ft.ElevatedButton("Agregar", on_click=lambda e: add_clicked(e, new_task, page), style=ft.ButtonStyle(color=ft.colors.PURPLE_300))
    modify_button = ft.ElevatedButton("Modificar", on_click=lambda e: modify_clicked(e, new_task), style=ft.ButtonStyle(color=ft.colors.PURPLE_300))
    delete_button = ft.ElevatedButton("Eliminar", on_click=lambda e: delete_clicked(e, page), style=ft.ButtonStyle(color=ft.colors.PURPLE_300))
